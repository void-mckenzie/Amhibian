...
class MetaDataset:
    ...
    def __init__(self, root, target_tasks, test_size=0.2, meta_train=True, seed=6,
        ...
        if meta_train:
            ...
            all_tasks = ['prostate_transitional_T2', 'pancreas_cancer', 'brain_ne_tumour_t1gd', 'brain_e_tumour_T2w', 'brain_edema_t1gd', 'brain_edema_FLAIR', 'prostate_peripheral_T2', 'brain_ne_tumour_T2w', 'heart', 'vessel_cancer', 'colon', 'brain_edema_T1w', 'brain_edema_T2w', 'hippocampus_posterior', 'pancreas', 'hippocampus_anterior', 'brain_ne_tumour_T1w', 'brain_e_tumour_T1w', 'vessel', 'brain_e_tumour_t1gd', 'brain_ne_tumour_FLAIR', 'spleen', 'lung', 'brain_e_tumour_FLAIR']
